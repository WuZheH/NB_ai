...
def test_public_chat_zotero_preview_filters_private_error_details(
    ...
    def fail(**_kwargs):
        raise zotero_selected_book_preview_service.ZoteroSelectedBookPreviewError(
            ...
            details={
                "zotero_item_key": "ABCD1234",
                "resolved_pdf_path": r"C:\synthetic\private.pdf",
                "snapshot_path": r"D:\synthetic\zotero.sqlite",
                "db_path": r"D:\synthetic\research.db",
                "zotero_data_dir": r"D:\synthetic\Zotero",
                "zotero_storage_root": r"D:\synthetic\storage",
            },
        )
