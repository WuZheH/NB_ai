...
export const READ_SERVER_INSTRUCTIONS = [
  ...
  "When list_library returns a zotero_source_revision for Zotero discovery, pass that revision unchanged to import_preview so the preview stays bound to the same immutable source capture; do not ask the user to copy it manually.",
