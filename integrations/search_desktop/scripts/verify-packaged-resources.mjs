...
const PACKAGED_PYTHON_RUNTIME_MODULES = Object.freeze([
  ...
  "scripts/maintenance/reconcile_search_book_deletion.py",
  "scripts/maintenance/smoke_search_book_deletion_isolated.py",
...
export const PACKAGED_RESOURCE_CONTRACT = Object.freeze([
  ...
  "resources/app/runtime-project/app/api/library/documents.py",
  "resources/app/runtime-project/app/api/library/management.py",
  "resources/app/runtime-project/app/schemas/library_deletion.py",
  "resources/app/runtime-project/app/services/library/book_archive_service.py",
  "resources/app/runtime-project/app/services/library/document_deletion_service.py",
  "resources/app/runtime-project/app/services/library/local_mutation_security.py",
...
const SOURCE_RESOURCE_CONTRACT = Object.freeze(new Map([
  ...
  ["resources/app/runtime-project/app/api/library/documents.py", resolve(DESKTOP_ROOT, "../../app/api/library/documents.py")],
  ["resources/app/runtime-project/app/api/library/management.py", resolve(DESKTOP_ROOT, "../../app/api/library/management.py")],
  ["resources/app/runtime-project/app/schemas/library_deletion.py", resolve(DESKTOP_ROOT, "../../app/schemas/library_deletion.py")],
  ["resources/app/runtime-project/app/services/library/book_archive_service.py", resolve(DESKTOP_ROOT, "../../app/services/library/book_archive_service.py")],
  ["resources/app/runtime-project/app/services/library/document_deletion_service.py", resolve(DESKTOP_ROOT, "../../app/services/library/document_deletion_service.py")],
  ["resources/app/runtime-project/app/services/library/local_mutation_security.py", resolve(DESKTOP_ROOT, "../../app/services/library/local_mutation_security.py")],
